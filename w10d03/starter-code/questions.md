...
```SQL
SELECT code, name, continent, population, surfacearea, indepyear, lifeexpectancy, gnp, gnpold, localname, governmentform, headofstate, capital FROM country WHERE region='Southern Europe' ORDER BY population;
```
**Answer:**
...
```SQL
SELECT name FROM city WHERE name ILIKE '% San %';
```
**Answer:**
