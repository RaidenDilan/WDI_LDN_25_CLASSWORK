...
class BirdsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bird" do
    assert_difference('Bird.count') do
      post birds_url, params: { bird: { family: @bird.family, image: @bird.image, latin_name: @bird.latin_name, name: @bird.name } }, as: :json
    end
  ...
  test "should update bird" do
    patch bird_url(@bird), params: { bird: { family: @bird.family, image: @bird.image, latin_name: @bird.latin_name, name: @bird.name } }, as: :json
    assert_response 200
  end
